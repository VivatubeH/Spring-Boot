...
public class Pagination {
	...
	/**
	 * 현재 페이지번호와 총 데이터갯수, 한 화면에 표시할 데이터 갯수를
	 ...
	 * @param totalRows 총 데이터 갯수
	 * @param rowsPerPage 한 화면에 표시할 데이터 갯수 
	 * @param pagesPerBlock 페이지 내비게이션의 한 블록에 표시할 페이지번호 갯수 
	 */
