...
public class Pagination {
	...
	private int rowsPerPage; // 페이지당 표시할 데이터 갯수
	...
	private int endPage; // 페이지 내비게이션에 표시할 끝 페이지 번호
	private boolean isFirst; // 첫 페이지면 true
	private boolean isLast; // 끝 페이지면 true
	private int prevPage; // 현재 페이지의 이전 페이지
	private int nextPage; // 현재 페이지의 다음 페이지
	...
	/**
	 * 현재 페이지번호와 총 데이터갯수, 한 화면에 표시할 데이터 갯수를 전달받아서 객체를 초기화하고,
	 * 페이징 처리에 필요한 값을 계산한다.
	 * @param page 현재 페이지 번호
	 * @param totalRows 총 데이터 갯수
	...
	/**
	 * 현재 페이지번호와 총 데이터갯수, 한 화면에 표시할 데이터 갯수,
	 * 페이지 네비게이션에 한 번에 표시할 페이지번호 갯수를 
	 * 전달받아서 객체를 초기화하고, 페이징처리에 필요한 값을 계산한다.
	 * @param page 현재 페이지 번호
	 * @param totalRows 총 데이터 갯수
	 * @param rowsPerPage 한 화면에 표시할 데이터 갯수
	 * @param pagesPerBlock 페이지 네비게이션의 한 블록에 표시할 데이터 갯수
	 */
