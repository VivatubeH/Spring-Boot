...
<script type="text/javascript">
	...
	// 정렬방식이 변경될 때
	function changeSort() {
		pageInput.value = 1; // 정렬방식이 바뀌면 무조건 1 페이지 요청
		form.submit();
	}
	...
	function searchValue() {
		pageInput.value = 1; // 새로 검색을 하면 무조건 1페이지 요청
		form.submit();
	}
